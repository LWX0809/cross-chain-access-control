package crosschain.threshPaillier.actors;

import java.io.DataOutputStream;
import java.io.File;
import java.io.FileOutputStream;

import crosschain.threshPaillier.messages.Messages.BGWNPoint;
import crosschain.threshPaillier.messages.Messages.BiprimalityTestResult;
import crosschain.threshPaillier.messages.Messages.CandidateN;
import crosschain.threshPaillier.messages.Messages.Participants;
import crosschain.threshPaillier.messages.Messages.QiTestForRound;
import crosschain.threshPaillier.messages.Messages.ThetaPoint;
import crosschain.threshPaillier.messages.Messages.VerificationKey;
import paillierp.key.PaillierPrivateThresholdKey;
import crosschain.threshPaillier.protocol.BGWParameters.BGWPublicParameters;
import crosschain.threshPaillier.protocol.KeysDerivationParameters.KeysDerivationPublicParameters;
import crosschain.threshPaillier.protocol.ProtocolParameters;
import crosschain.threshPaillier.actordata.ProtocolData;
import crosschain.threshPaillier.actors.ProtocolActor.States;
 ...
 */
public class ProtocolActor extends AbstractLoggingFSM<ProtocolActor.States, ProtocolData> {
