...
private static boolean belongToZStarNSquare(BigInteger c,
    ...
    public static void main(String[] args) throws Exception {
        Paillier1 paillier = new Paillier1();
// KeyGeneration
...
// Encryption and Decryption
        ...
        try {
            c = Paillier1.encrypt(m, pubkey);
            decrypted_m = Paillier1.decrypt(c, pubkey, prikey);
        } catch (Exception e) {
...
// Addition
        ...
        try {
            BigInteger c1 = Paillier1.encrypt(m1, pubkey);
            BigInteger c2 = Paillier1.encrypt(m2, pubkey);
            BigInteger c1mulc2 = Paillier1.add(c1, c2, pubkey);
            BigInteger decrypted_c1mulc2 =
                    Paillier1.decrypt(c1mulc2, pubkey, prikey);
...
// Multiplication
        ...
        try {
            BigInteger c1 = Paillier1.encrypt(m1, pubkey);
            BigInteger c1expm2 = Paillier1.mul(c1, m2, pubkey);
            BigInteger decrypted_c1expm2 =
                    Paillier1.decrypt(c1expm2, pubkey, prikey);
...
// Self-Blinding
        m1 = new BigInteger("12345");
        BigInteger r2 = Paillier1.randomZStarN(pubkey.getN());
        try {
            BigInteger c1 = Paillier1.encrypt(m1, pubkey);
            BigInteger c1mulrn = Paillier1.selfBlind(c1, r2,
                    pubkey);
            BigInteger decrypted_c1mulrn =
                    Paillier1.decrypt(c1mulrn, pubkey, prikey);
        ...
        //test ok
//        BigInteger plaintext1 = new BigInteger("11");
...
//        }
    ...
    public int comparePlaintext(BigInteger plaintext1, BigInteger plaintext2) throws Exception {

        BigInteger ciphertext1 = Paillier1.encrypt(plaintext1,pubkey);
        BigInteger ciphertext2 = Paillier1.encrypt(plaintext2,pubkey);

        //C_=C1/C2  M_=m1-m2
        BigInteger ciphertext_ = Paillier1.sub(ciphertext1,ciphertext2,pubkey);

        //加法因子
        BigInteger plaintext3 = new BigInteger("15");
        BigInteger ciphertext3 = Paillier1.encrypt(plaintext3,pubkey);

        //C__=C1/C2*C3  M__=M1-M2+M3   ,M3>M1 ,M3>M2 远大于 加法因子外部不知道
        BigInteger C__ = Paillier1.add(ciphertext_,ciphertext3,pubkey);
        BigInteger M__ = Paillier1.decrypt(C__,pubkey,prikey);
    ...
    //密文
    public int compareCipertext(BigInteger ciphertext1, BigInteger ciphertext2) throws Exception {
